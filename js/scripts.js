...
$(() => {
	...
	if ($('.product-used__slider').length) {
		new Swiper(".product-used__slider", {
			loop: false,
			spaceBetween: 24,
			slidesPerView: 1,
			speed: 500,
	...
	if ($('.products-found__slider').length) {
		new Swiper(".products-found__slider", {
			loop: false,
			spaceBetween: 24,
			slidesPerView: 'auto',
			watchSlidesProgress: true,
